...
class Result:
    def __init__(self, attempts, name, secret_number, wrong_guesses):
...
def play_game(level="easy", score_list="[]"):
    ...
    while True:
        ...
        if guess == secret:
            ...
            current_result = Result(attempts=attempts, name=player_name, secret_number=secret, wrong_guesses=wrong_guess_list)

            score_list.append(current_result.__dict__)
